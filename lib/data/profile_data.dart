...
class ProfileData {
  static final List<ProfileFacts> facts = [
    ProfileFacts(title: "About Cineflix", facts: [
      ...
      "On each film page, the user can watch the trailer directly or get redirected on Youtube and share the movie on social medias and messaging apps.",
      "The user can also mark the film as watched or unwatched.",
      "A recommandation model is available in the app, making suggestions to the user based on its preferences (= favorites) and popular movies."
    ]),
