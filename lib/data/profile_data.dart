...
class ProfileData {
  static final List<ProfileFacts> facts = [
    ProfileFacts(title: "About Cineflix", facts: [
      "Cineflix is a mobile app based on Flutter. It allows the user to search movies and them as favorites.",
      ...
      "An AI model is embedded into the app, making suggestions to user based on its preferences (= favorites) and popular movies."
    ]),
